...
export const Logo = ({ className = "" }: LogoProps) => (
  <Link href="/" aria-label="Home">
    <div className="group relative lg:h-[80px] lg:w-[95px] sm:w-[85px] sm:h-[70px] w-[78px] h-[66px] overflow-hidden rounded-md flex justify-center items-center transition-all duration-300 hover:scale-[1] hover:shadow-[0px_4px_15px_rgba(255,255,255,0.1)] dark:hover:shadow-[0px_4px_15px_rgba(255,255,255,0.15)] border border-white/10">
      ...
      <Image
        ...
        width={1000}
        height={1000}
        className={`h-full w-full scale-[1.8] object-cover rounded-full transition-transform duration-300 group-hover:scale-[1.55] ${className}`}
        priority
      />
    </div>
  </Link>
